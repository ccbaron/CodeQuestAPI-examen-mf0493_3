...
const getRandomQuestions = async (req, res) => {
  try {
	...
	// construimos un filtro de dificultad easy, medium y hard
    const filter = {};
    if (typeof difficulty === 'string') {
      ...
      // si no es válida, se ignora (comportamiento sigue como hasta ahora)
    }

	// Pasamos amount + filter al servicio existente
